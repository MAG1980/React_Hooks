...
Функция очистки useEffect вызывается перед демонтированием компонента, а также перед каждым срабатыванием сайд-эффекта.
...
а функция очистки - при демонтировании компонента.
